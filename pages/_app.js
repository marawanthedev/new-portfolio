...
const App = ({ Component, pageProps }) => {
  ...
  return (
    <Fragment>
      <Head>
        <title>Marwan Mostafa - Software Engineer|ReactJS|LLM</title>
        <meta httpEquiv="Content-Type" content="text/html; charset=utf-8" />
        <meta httpEquiv="X-UA-Compatible" content="IE=edge" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta name="HandheldFriendly" content="true" />
        
        <meta name="description" content="Marwan Mostafa, a React.js frontend developer with 3 years of experience in TypeScript , AI and LLM enthusiast. available for hiring." />
        <meta name="keywords" content="Marwan Mostafa, Marwan Nassef, Marwan Developer, Marwan frontend, AWS,, React.js, frontend developer, remote work, TypeScript, Node.js, backend, AWS, hiring, AI, LLM, OpenAI, Chatbot, React Engineer in Malaysia, React Engineer available for remote hiring, Remote software engineer, React Talent" />
        <meta name="author" content="Marwan Mostafa" />
        <meta property="og:title" content="Marwan Mostafa -Software Engineer|ReactJS|LLM" />
        <meta property="og:description" content="Marwan Mostafa, a React.js frontend developer with 3 years of experience in TypeScript , AI and LLM enthusiast. available for hiring." />
